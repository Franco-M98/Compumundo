...
<html>
  ...
  <body>
    ...
    <header>
      ...
      <!-- Navbar Header  -->
      <nav class="navbar border-bottom navbar-expand-lg navbar-sticky navbar-airy navbar-light bg-white bg-fixed-white navbar-hover-light navbar-fixed-light">
        <div class="container-fluid">  
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              <li class="nav-item active" id=""><img src="img/Otros/Menu/information.png" width="20" height="20"><a href="index.php/../#QuienesSomos?" class="nav-link py-0">Quiénes somos?</a></li>
              <li class="nav-item active" id=""><img src="img/Otros/Menu/home.png" width="20" height="20"><a href="index.php/../#Inicio" class="nav-link py-0">Inicio</a></li>
              <li class="nav-item active" id=""><img src="img/Otros/Menu/ubicacion.png" width="20" height="20"><a href="index.php/../#Ubicacion" class="nav-link py-0">Ubicación</a></li>
              <li class="nav-item active" id=""><img src="img/Otros/Menu/variassucursales.png" width="20" height="20"><a href="index.php/../#Sucursales" class="nav-link py-0">Sucursales</a></li>
