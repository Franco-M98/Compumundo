                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="py-3">
                          ...
                          <div class="form-group row">
                            <div class="col-sm-12">
                              <input type="email" class="form-control" id="usuario" placeholder="Usuario@correo.com" name="User"  />
                              </div>
                          </div>
                        
                            <div class="form-group row">
                              <div class="col-8 col-sm-6 is-valid">
                                <input type="password" class="form-control" id="contrasena" placeholder="Contraseña" name="Clave"  />
                              </div>
                              <div class="col-4 col-sm-6">
                                <input type="password" class="form-control" id="contrasena1" placeholder="Confirmación" name="Clave1"  />
                              </div>
