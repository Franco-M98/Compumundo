<div class="card col-sm-12 shadow-lg">
  <div class="row">
    ...
    <div class="col-4 col-sm-6">
      <div class="card-body">
        <h3><p class="d-inline-block py-2 mb-2 text-muted"><?php echo $row ['Producto']; ?></p><img class="" src="https://http2.mlstatic.com/D_Q_NP_707919-MLA27179994160_042018-N.webp" width="60" height="60"></h3>
        <div class="form-row">
          ...
          <div class="col-10 py-1">
            <h4 class="card-text text-warning"><font face="Decorative">Inicie sesión o registrese, para ver el precio del producto.</font></h4>
          </div>
        </div>
